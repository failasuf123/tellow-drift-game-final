...
var peoples_target_lvl2 = 40
var peoples_target_lvl3 = 100
...
func _ready():
	...
	# Hubungkan signal dengan cara yang lebih aman
	...
	if player.has_signal("people_collected"):
		player.connect("people_collected", Callable(self, "_on_people_collected"))
	else:
...
func _on_player_people_collected(current_peoples):  # Fungsi handler baru
	people_counter_label.text = str(current_peoples)
	if current_peoples >= 40:
		get_tree().change_scene_to_file("res://scenes/win_lvl_2.tscn")

func show_win_screen():
	print("You Win!")
	# Tambahkan logika menang di sini
...
func _on_player_died():
	...
	get_tree().change_scene_to_file("res://scenes/lose_lvl_2.tscn")
